...
public class SList {
  ...
  public static void main (String[] args) {
	...
	mylist.insertFront(new Integer(12));
	mylist.insertFront(new Integer(9));
	mylist.insertFront(new Integer(6));
	System.out.println(mylist.toString());
	
	mylist.insertEnd(new Integer(15));
	mylist.insertFront(new Integer(3));
	System.out.println(mylist.toString());
