...
public class DList {
  ...
  public void insertFront(Object item) {
    // Your solution here.
	DListNode theNewNode=newNode(item, head, head.next);
  ...
  public void insertBack(Object item) {
    // Your solution here.
	DListNode theNewNode=newNode(item, head.prev, head);
  ...
  public void insertAfter(Object item, DListNode node) {
    // Your solution here.
	if (node != null) {
		DListNode theNewNode=newNode(item, node, node.next);
  ...
  public void insertBefore(Object item, DListNode node) {
    // Your solution here.
	if (node != null) {
		DListNode theNewNode=newNode(item, node.prev, node);
