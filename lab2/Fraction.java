...
class Fraction {
  ...
  public int fracs() {                         // DO NOT CHANGE THIS SIGNATURE!
    // Fix the bug that prevents this method from working correctly.
    return Fraction.numberOfFractions;
  }
  ...
  public static void main(String[] argv) {
    ...
    Fraction sumOfTwo = new Fraction(f1.numerator*f2.denominator+f1.denominator*f2.numerator, f1.denominator*f2.denominator);              // Sum of f1 and f2.
    Fraction sumOfThree = new Fraction(f0.numerator*f1.denominator*f2.denominator+f1.numerator*f0.denominator*f2.denominator+f2.numerator*f0.denominator*f1.denominator, f0.denominator*f1.denominator*f2.denominator);             // Sum of f0, f1, and f2.
